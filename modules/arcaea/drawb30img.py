...
def drawb30(Username, b30, r10, ptt, character, path='', official=False):
    ...
    if not official:
        ...
        b30img.alpha_composite(pttimg.convert(
            "RGBA"), (b30img.width - 450, 67))
    ...
    pttimg = Image.new(
        "RGBA", (font1_width + font2_width + 4, font1_height + 4))
    ...
    drawptt.text((font1_width, 9), ptt2, 'white', font=font2,
                 stroke_width=2, stroke_fill=stroke_color)
    ...
    if not official:
        textdraw.text((1871, 1225), Username, '#3a4853', font=userfont,
                      stroke_width=2, stroke_fill='white')
    else:
        textdraw.text((b30img.width - 365, 70), Username, '#3a4853',
                      font=userfont, stroke_width=2, stroke_fill='white')
    # b30
    b30font = ImageFont.truetype(f'{assets_path}/Fonts/Exo-Medium.ttf', 17)
    br30 = f'B30: {str(b30)}  R10: {str(r10)}'
    if not official:
        textdraw.text((1876, 1270), br30, '#3a4853', font=b30font,
                      stroke_width=2, stroke_fill='white')
    else:
        textdraw.text((b30img.width - 360, 113), br30, '#3a4853',
                      font=b30font, stroke_width=2, stroke_fill='white')
    # disclaimer
    disclaimer_font = ImageFont.truetype(
        f'{assets_path}/Fonts/Exo-Medium.ttf', 25)
    if official:
    ...
    while True:
        try:
            ...
            i += 1
            cardimg = makeShadow(
                cardimg, 4, 9, [0, 3], 'rgba(0,0,0,0)', '#000000')
