...
from .maimaidx_music import TotalList, get_cover_len4_id
...
class DrawBest(object):
    ...
    def __init__(self, sdBest: BestList, dxBest: BestList, userName: str, playerRating: int, musicRating: int):
        ...
        self.img = Image.open(
            self.pic_dir + 'UI_TTR_BG_Base_Plus.png').convert('RGBA')
        self.ROWS_IMG = [2]
        for i in range(6):
    ...
    def _drawBestList(self, img: Image.Image, sdBest: BestList, dxBest: BestList):
        ...
        for num in range(0, len(sdBest)):
            ...
            font = ImageFont.truetype(
                'assets/maimai/static/adobe_simhei.otf', 12, encoding='utf-8')
            tempDraw.text(
                (8, 44), f'Base: {chartInfo.ds} -> {chartInfo.ra}', 'white', font)
            font = ImageFont.truetype(
                'assets/maimai/static/adobe_simhei.otf', 18, encoding='utf-8')
        ...
        for num in range(0, len(dxBest)):
            ...
            recBase = recBase.point(lambda p: int(p * 0.8))
            img.paste(
                recBase, (self.COLOUMS_IMG[j + 6] + 5, self.ROWS_IMG[i + 1] + 5))
            img.paste(
    ...
    def draw(self):
        splashLogo = Image.open(
            self.pic_dir + 'UI_CMN_TabTitle_MaimaiTitle_Ver214.png').convert('RGBA')
        ...
        font1 = ImageFont.truetype(
            'assets/maimai/static/msyh.ttc', 28, encoding='unic')
        ...
        font2 = ImageFont.truetype(
            'assets/maimai/static/adobe_simhei.otf', 14, encoding='utf-8')
        ...
        self.img.paste(authorBoardImg, (1224, 19),
